...
public:
	 ...
	 */
	static void render(IPaintable<RGB>* surface, uint32_t x, uint32_t y, float level, float low_threshold, TColour outline_colour, TColour good_colour, TColour low_colour)
	{
