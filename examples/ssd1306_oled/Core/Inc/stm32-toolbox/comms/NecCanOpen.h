/**
 * \file       comms/NecCanOpen.h
 * \class      NecCanOpen
 * \brief      Encapsulates CANopen communications with the NEC 12V35i battery by extending the CanBus class.
 */
...
class NecCanOpen : public CanBus
{
public:
	 ...
	 */
	NecCanOpen(Nec12V35i* batteries) : CanBus(&::hcan)
	{
...
private:
	...
	void on_message(uint16_t address, uint8_t* data, uint8_t length) override
	{
		...
		Nec12V35i *battery = &batteries[battery_index];
