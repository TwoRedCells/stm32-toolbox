...
namespace fastdelegate {	// we'll hide the implementation fastdelegates in a nested namespace.
...
protected: 
	...
	typedef void (fastdelegate::GenericClass::*GenericMemFuncType)(); // arbitrary MFP.
	fastdelegate::GenericClass *m_pthis;
